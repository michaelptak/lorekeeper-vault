...
if (hasNewStoryTitle || hasUntitledTitle) {
    title = await tp.system.prompt("Enter Scene Timeline Name");
...
const targetFolder = `Story/${selectedStory}/Timelines`;
...
> **Timelines** | `INPUT[list(placeholder(story-timeline/chapter-timeline)):timelines]` |
